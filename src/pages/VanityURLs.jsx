    ...
    <div className="p-4 sm:p-6 md:p-8">
      <header className="mb-6 md:mb-8 flex flex-col xl:flex-row justify-between items-start xl:items-center gap-4">
        <div className="flex-shrink-0 min-w-max">
          <h2 className="text-2xl md:text-3xl font-bold text-slate-900 dark:text-slate-100 whitespace-nowrap">Vanity URLs</h2>
          <p className="text-sm md:text-base text-slate-500 dark:text-slate-400 mt-1 whitespace-nowrap">Manage and track all Vanity URLs</p>
        </div>
        ...
        <table className="w-full text-left min-w-[1000px]">
          ...
          <tbody className="divide-y divide-slate-100 dark:divide-slate-800 text-sm">
            {loading ? (
              ...
              <tr><td colSpan="8" className="p-12 text-center text-slate-400 dark:text-slate-500">No records found matching your criteria.</td></tr>
              ...
              <tr key={record.id} className="hover:bg-slate-50 dark:hover:bg-slate-800/40 transition-colors">
                ...
                <td className="p-4">
                  {record.expiryDate ? (
                    <span className={`font-medium ${new Date(record.expiryDate) < new Date() ? 'text-red-600 dark:text-red-400' : 'text-slate-700 dark:text-slate-300'}`}>
