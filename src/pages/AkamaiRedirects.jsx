  ...
  return (
    <div className="p-4 sm:p-6 md:p-8">
      <header className="mb-6 md:mb-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h2 className="text-2xl md:text-3xl font-bold text-slate-900">Akamai 301 Redirects</h2>
          <p className="text-sm md:text-base text-slate-500 mt-1">Manage and track all Akamai 301 Redirects</p>
        </div>
