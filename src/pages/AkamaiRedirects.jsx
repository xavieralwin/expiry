    ...
    <div className="p-4 sm:p-6 md:p-8">
      <header className="mb-6 md:mb-8 flex flex-col xl:flex-row justify-between items-start xl:items-center gap-4">
        <div className="flex-shrink-0 min-w-max">
          <h2 className="text-2xl md:text-3xl font-bold text-slate-900 dark:text-slate-100 whitespace-nowrap">Akamai 301 Redirects</h2>
          <p className="text-sm md:text-base text-slate-500 dark:text-slate-400 mt-1 whitespace-nowrap">Manage and track all Akamai 301 Redirects</p>
        </div>
              ...
              <tr key={record.id} className="hover:bg-slate-50 dark:hover:bg-slate-800/40 transition-colors">
                <td className="p-4">
                  <div className="w-64 lg:w-96">
                    <a href={record.url} target="_blank" rel="noreferrer" className="text-purple-600 dark:text-purple-400 hover:text-purple-800 dark:hover:text-purple-300 hover:underline flex items-center gap-1 truncate" title={record.url}>
